// GitHub and X paths from Simple Icons (https://simpleicons.org)
// LinkedIn path from official brand assets, normalized to 0 0 24 24 viewBox
// Mail icon from Lucide (stroke-based, same viewBox)
